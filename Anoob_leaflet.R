...
m <- leaflet() %>%
  addTiles() %>%
  addMarkers(lng = -73.203, lat = 44.4783, popup = "landmark")
...
# map views 
m %>% setView(-73.203, 44.48, zoom = 16)
m %>% fitBounds(-73.203, 44.48, -73.1, 44.49)
m %>% setMaxBounds(-73.203, 44.48, -73.1, 44.49)
...
# Markers
data(quakes) # locations of the earthquakes of Fiji
head(quakes)
