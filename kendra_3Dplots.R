...
scatter3D(x,y,z, bty="u", colkey = T, col = "steelblue", 
          col.panel = "grey", col.grid="black")
...
scatter3D(x,y,z, bty = "b2", theta = 40, phi=20)
...
text3D(x,y,z, labels = rownames(airquality), 
       add=TRUE, cex=0.5)
...
scatter3D(x,y,z, bty = "b2", pch=20,
          cex=0.8, theta = 10, phi = 10, 
          col=gg2.col(100),
